...
namespace AddHole
{
    ...
    public class AddHole : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            Document ovDoc = arDoc.Application.Documents.OfType<Document>().FirstOrDefault(x => x.Title.Contains("ОВ"));
            if (ovDoc == null)
            {
            ...
            FamilySymbol familySymbol = new FilteredElementCollector(arDoc)
                ...
                .OfType<FamilySymbol>()
                .FirstOrDefault(x => x.FamilyName.Equals("Отверстия"));
            ...
            Transaction transaction = new Transaction(arDoc, "Расстановка отвертсий");
            transaction.Start();
